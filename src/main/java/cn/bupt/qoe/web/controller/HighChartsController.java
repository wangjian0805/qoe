...
public class HighChartsController {
	...
	public WebResult getScoreData(@RequestParam(value = "mac_time", required = false) String mac_time) {
		WebResult result = new WebResult();
		List<List> list = new ArrayList<>();
		String[] xs = { "1s", "2s", "3s", "4s", "5s", "6s", "7s", "8s", "9s", "10s", "11s", "12s", "13s", "14s", "15s",
				"16s", "17s", "18s", "19s", "20s", "21s", "22s", "23s", "24s", "25s", "26s", "27s", "28s", "29s",
				"30s" };
		...
		Double[] ds1 = { 1.2, 3.4, 4.6, 9.9, 11.0, 13.2, 13.9, 17.5, 20.8, 26.4, 29.2, 32.3, 34.0, 35.3, 36.0, 45.6,
				48.5, 49.9, 51.4, 52.3, 68.1, 69.3, 72.6, 77.6, 84.4, 87.3, 92.3, 94.2, 97.5, 100.0 };
		Double[] ds2 = { 2.1, 4.2, 5.2, 8.9, 10.9, 14.0, 15.3, 18.5, 24.6, 29.4, 30.2, 35.2, 44.0, 45.2, 47.0, 48.6,
				58.5, 59.9, 63.4, 63.4, 74.1, 76.9, 80.6, 83.2, 94.4, 99.0, 100.0, 100.0, 100.0, 100.0 };
