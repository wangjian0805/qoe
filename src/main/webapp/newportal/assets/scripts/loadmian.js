function showMapData() {
	...
	map.centerAndZoom(point, 23); // 初始化地图，设置中心点坐标和地图级别
	map.enableScrollWheelZoom(); // 允许滚轮缩放
	var myIcon1 = new BMap.Icon("../img/transparent.png", new BMap.Size(10, 10), {
		imageOffset : new BMap.Size(0, 0)
	});
	var myShadowIcon = new BMap.Icon("../img/transparent.png", new BMap.Size(10, 10), {
		imageOffset : new BMap.Size(0, 0)
	});
	var points = [];
	...
	$.ajax({
		url : "http://10.103.93.23:8080/qoe/api/detect/heatmapdata",
		dataType : "json",
		type : "GET",
